        ...
        <div class="row">
            ...
            <div class="col l4 m4 s12">
                <div class="card-panel white" style="background: url(img/brick-wall.png);">
                    ...
                    <form action="controllers/RegistroMedico.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-field">
                            ...
                            <label for="experiencia">Ingrese experiencia</label>
                        </div>
                        <div class="file-field input-field">
                            <div class="btn teal lighten-2">
                                <span>Foto</span>
                                <input type="file" name="foto" @change="onFileSelected">
                            </div>
                            <div class="file-path-wrapper">
                                <input class="file-path validate" type="text" v-model="foto.name">
                            </div>
                        </div>
                        ...
                        <br>
                        <br>
                        <a href="login_m.php" class="right">Ya tienes una cuenta?</a>
                        <br>
